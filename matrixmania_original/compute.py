...
if __name__ == "__main__":
    ...
    #print(tabulate(transpose(mat4)))
    #print(tabulate(rot_2D(20.333)))
    #print(tabulate(rot_3D(20.333, "X")))
    #print(tabulate(rot_3D(20.333, "Y")))
    #print(tabulate(rot_3D(20.333, "Z")))
    #print(tabulate(rot_3D(20.333, "X")))
    print(project_ortho((0.5, -0.5, 10), scale= 200))
#hab alles selbst programmiert
